...
Data Loading: Loaded the dataset using pandas to read mushrooms.csv.
Exploratory Data Analysis (EDA): Visualized the distribution of the class variable and explored relationships between features (e.g., cap-color, odor) and the target using seaborn count plots.
Data Preprocessing:
...
Model Evaluation: Evaluated both models using accuracy, confusion matrix, and classification report.
